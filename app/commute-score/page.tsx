  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (allResults.length > 0) {
        ...
        // Create combined map data with all routes
                          ...
                          <div key={scoreData.mode} className='flex items-center justify-between p-3 rounded-lg bg-gray-50'>
                            <div className='flex items-center space-x-3'>
                              <div className='flex items-center space-x-2'>
                                ...
                                {scoreData.mode === 'bike' && <Bike className='h-5 w-5 text-yellow-600' />}
                      ...
                      {commuteScores.length > 0 && (
                        <div className='mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
                          <div className='flex items-center justify-between'>
                            <div>
                              <h3 className='font-semibold text-blue-900'>Best Commute Option</h3>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Comprehensive commute analysis for each Microsoft office</CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='flex items-start space-x-3'>
                <Clock className='h-5 w-5 text-blue-600 mt-0.5' />
                <div>
                  <h4 className='font-semibold'>Travel Time Analysis</h4>
                  <p className='text-sm text-gray-600'>Detailed timing for driving, transit, and bike options</p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>A-F grades considering time, convenience, and reliability</p>
                </div>
              </div>
            </CardContent>
          </Card>
