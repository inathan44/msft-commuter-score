    ...
    <div className='container mx-auto py-8 px-4 max-w-6xl'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
        ...
        <div>
          ...
          {submittedData && !isSearching && (
            <Card className='mt-6'>
              <CardHeader>
                <CardTitle>Commute Analysis Results</CardTitle>
                <CardDescription>
                  Here&apos;s your commute analysis based on the selected transportation preferences and time limits.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-4'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='bg-muted p-3 rounded-md'>
                      ...
                      <p className='text-sm font-medium capitalize'>{submittedData.transportationMethods.join(', ')}</p>
                    </div>
                    <div className='bg-muted p-3 rounded-md'>
